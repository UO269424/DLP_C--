				...
				if ( _alt==1 ) {
					...
					do {
						...
						case 1:
							...
							setState(196);
							match(T__5);
							_localctx.dimensions.add(Integer.parseInt((((TypeContext)_localctx).ic!=null?((TypeContext)_localctx).ic.getText():null)));
							}
							}
							break;
						default:
					...
					((TypeContext)_localctx).ast =  ParserHelper.buildArrayType(((TypeContext)_localctx).t1.ast, _localctx.dimensions);
					}
					} 
				}
				setState(207);
